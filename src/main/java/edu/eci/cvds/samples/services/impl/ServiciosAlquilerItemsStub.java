...
public class ServiciosAlquilerItemsStub implements ServiciosAlquiler {
    ...
    @Override
    public int valorMultaRetrasoxDia(int itemId) throws ServiciosAlquilerException {
    ...
    @Transactional
    @Override
    public void registrarCliente(Cliente p) throws ServiciosAlquilerException {
        if (!clientes.containsKey(p.getDocumento())) {
            clientes.put(p.getDocumento(), p);
        } else {
            throw new ServiciosAlquilerException("El cliente con documento "+p+" ya esta registrado.");
        }
    }
    ...
    public void vetarCliente(long docu, boolean estado) throws ServiciosAlquilerException {
        ...
        else{throw new ServiciosAlquilerException("Cliente no registrado:"+docu);}
    }
    ...
    public Item consultarItem(int id) throws ServiciosAlquilerException {
        ...
        if(itemsDisponibles.containsKey(id)){
            ...
            throw new ServiciosAlquilerException("Item no registrado:"+id);
        }
        return i;
    }
    ...
    public void registrarItem(Item i) throws ServiciosAlquilerException {
        if (!itemsDisponibles.containsKey(i.getId())) {
            ...
            throw new ServiciosAlquilerException("El item " + i.getId() + " ya esta registrado.");
        }
    }
    ...
    public void actualizarTarifaItem(int id, long tarifa) throws ServiciosAlquilerException {
        if (!itemsDisponibles.containsKey(id)) {
            ...
            throw new ServiciosAlquilerException("El item " + id + " no esta registrado.");
        }
    }
    ...
    public void registrarAlquilerCliente(Date date,long docu, Item item, int numdias) throws ServiciosAlquilerException {
        ...
        if (clientes.containsKey(docu)) {
            ...
            throw new ServiciosAlquilerException("No existe el cliente con el documento " + docu);
        }
    }
    ...
    public List<ItemRentado> consultarItemsCliente(long idcliente) throws ServiciosAlquilerException{
        if (clientes.containsKey(idcliente)) {
            ...
            throw new ServiciosAlquilerException("Cliente no registrado:" + idcliente);
        }

    }

    private Cliente consultarClienteConItem(int iditem) throws ServiciosAlquilerException{
        if (mapaPrestamosPorIdCliente.containsKey(iditem)){
            ...
            if (clientes.containsKey(mapaPrestamosPorIdCliente.get(iditem))){
                ...
                throw new ServiciosAlquilerException("El cliente "+idcli+" asociado al "
                        + "alquiler del item "+iditem+" no esta registrado.");
            }
        }
        else{
            throw new ServiciosAlquilerException("El item "+iditem+ " no esta alquilado.");
        }
    }
    ...
    public long consultarMultaAlquiler(int iditem,Date fechaDevolucion) throws ServiciosAlquilerException{
        if (!itemsrentados.containsKey(iditem)){
            throw new ServiciosAlquilerException("El item "+iditem+"no esta en alquiler");
        }
        else{
    ...
    public long consultarCostoAlquiler(int iditem, int numdias) throws ServiciosAlquilerException {
        if (!itemsDisponibles.containsKey(iditem)) {
            throw new ServiciosAlquilerException("El item " + iditem + " no esta disponible.");
        } else {
    ...
    private void poblar() {
        ...
        TipoItem ti1=new TipoItem(1,"Peliculas");
